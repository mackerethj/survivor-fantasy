...
const S50_EPISODES = [
  {
    ...
    advantages: [
      { holder: "Rizo Velovic", kind: "advantage", type: "Idol", status: "active", note: "Genevieve found her second Billie Eilish Boomerang Idol while shadowing Aubry on an idol hunt. Rather than keeping it, she gave it to Rizo — calculating that he trusts her enough that she can eventually blindside him to get it back. Rizo received it hidden in his bag and was immediately stoked, flashing back to the idol antics that defined his Season 49 game." },
    ...
    recap: "Cila held a camp talent show won by Rizo's Mickey Mouse impression. On Kalo, Genevieve found a third Boomerang Idol while shadowing Aubry and secretly passed it to Rizo, planning to blindside him later and get it back. The combined reward/immunity challenge had tribes raise a submerged boat, then solve a letter-cube arch puzzle spelling CELEBRATION — Kalo won first, earning a Sanctuary visit with country star Zac Brown (spearfishing and a private concert), while Vatu lost and went to Tribal. At Vatu, Mike tried to pitch Emily as the vote to pull Christian away from Ozzy — Christian saw through it, flipped with Stephenie and Emily, and blindsided Mike 3-2-1. Ozzy was kept out of the plan and was somehow more upset than Mike.",
  },
  {
    number: 3,
    title: "Episode 3",
